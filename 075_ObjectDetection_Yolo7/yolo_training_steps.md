...
```
(pytorch) C:\...> git clone https://github.com/WongKinYiu/yolov7.git https://github.com/WongKinYiu/yolov7.git
```
...
```
(pytorch) C:\...> python detect.py --weights runs/train/yolov74/weights/best.pt --conf 0.4 --img-size 640 --source ./test/images/maksssksksss824.png

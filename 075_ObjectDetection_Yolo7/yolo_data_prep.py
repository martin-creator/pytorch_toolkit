...
base_folder = 'yolov7'
create_folder(os.path.join(base_folder, 'train', 'images'))
create_folder(os.path.join(base_folder, 'train', 'labels'))
create_folder(os.path.join(base_folder, 'val', 'images'))
create_folder(os.path.join(base_folder, 'val', 'labels'))
create_folder(os.path.join(base_folder, 'test', 'images'))
create_folder(os.path.join(base_folder, 'test', 'labels'))

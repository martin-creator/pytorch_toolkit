...
class MovieDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #return torch.tensor(users, dtype=torch.long), torch.tensor(movies, dtype=torch.long), torch.tensor(ratings, dtype=torch.long)
        return (
    torch.tensor(users.astype(numpy.int64), dtype=torch.long),
    torch.tensor(movies.astype(numpy.int64), dtype=torch.long),
    torch.tensor(ratings.astype(numpy.int64), dtype=torch.long)
)
